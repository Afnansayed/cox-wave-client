...
export default function ContactPage() {
  return (
    <main className="relative min-h-screen flex items-center justify-center py-12 overflow-hidden">
      {/* BACKGROUND IMAGE WITH OVERLAY */}
      <div 
        className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: `url('https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=2000')` }}
      >
        <div className="absolute inset-0 bg-neutral-900/80 backdrop-blur-[4px]" />
      </div>
      ...
      <div className="container-max px-6 relative z-10 max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 overflow-hidden">
          ...
          <div className="bg-white/5 backdrop-blur-2xl border border-white/10 p-8 md:p-12 flex flex-col justify-between space-y-8 rounded-[2rem]">
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4 group">
                ...
                <div className="space-y-1">
                  <h3 className="text-secondary-light text-[10px] font-black uppercase tracking-[0.2em]">Dhaka Office</h3>
              ...
              <div className="flex gap-4 group">
                ...
                <div className="space-y-1">
                  <h3 className="text-secondary-light text-[10px] font-black uppercase tracking-[0.2em]">Cox's Bazar Office</h3>
          ...
          <div className="bg-white p-8 md:p-12 flex flex-col justify-center rounded-[2rem] shadow-xl border border-neutral-100">
            ...
            <form className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input 
                    ...
                    className="w-full bg-neutral-50 border border-neutral-200 rounded-xl h-11 px-4 text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all"
                  />
                </div>
                <div className="space-y-1.5">
              ...
              <div className="space-y-1.5">
                ...
                <textarea 
                  ...
                  rows={3}
                  className="w-full bg-neutral-50 border border-neutral-200 rounded-xl p-4 text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all resize-none"
                />
              </div>

              <Button className="bg-primary hover:bg-primary-dark text-white px-10 h-12 rounded-full font-black text-xs uppercase tracking-widest transition-all w-full md:w-auto shadow-lg shadow-primary/20">
                Send Message
