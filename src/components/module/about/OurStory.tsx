        ...
        <section className="py-12 bg-white overflow-hidden relative">
            ...
            <div className="container-max px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2">
                            {[
                                ...
                                <div key={i} className="flex items-center gap-3">
                                    ...
                                    <span className="text-xs font-black text-neutral-800 uppercase tracking-tight">{item.label}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <motion.div className="lg:col-span-7 relative" {...fadeIn}>
                    <div className="relative aspect-video rounded-[3rem] md:rounded-[5rem] overflow-hidden shadow-2xl border-4 border-white shadow-primary/10">
                        <Image
