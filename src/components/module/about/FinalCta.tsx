    ...
    return (
        <section className="py-12 bg-background relative overflow-hidden">
            <div className="container-max px-6">
                <div className="relative bg-muted/30 rounded-[3rem] p-12  text-center space-y-6 overflow-hidden shadow-sm border border-border">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10">
                        <Link href="/event" className="w-full sm:w-auto">
                            <Button className="w-full bg-primary hover:bg-primary/90 text-white h-12 px-10 rounded-full font-black text-sm uppercase tracking-widest shadow-xl shadow-primary/20 transition-all">
                                Explore Experiences
                            </Button>
                        </Link>
                        <Link href="/contact" className="w-full sm:w-auto">
                            <Button variant="outline" className="w-full h-12 px-10 rounded-full border-border text-foreground hover:bg-muted font-black text-sm uppercase tracking-widest transition-all">
                                Contact Support
                            </Button>
                        </Link>
                    </div>
