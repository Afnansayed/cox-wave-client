        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-sm md:text-base text-neutral-500 font-medium leading-relaxed max-w-sm">
            ...
            <div className="flex items-center gap-8">
              ...
              <div className="text-xs font-bold text-neutral-400 uppercase tracking-widest">
                Trusted by <br /> <span className="text-neutral-900">Global Travelers</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 relative">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {TRENDING.map((item, i) => (
                <div key={i} className="group bg-neutral-50 rounded-[2rem] p-4 border border-neutral-100 transition-all hover:shadow-xl hover:shadow-primary/5">
